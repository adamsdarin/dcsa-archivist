...
Report candidate findings and unresolved records. `publish` auto-approves only after validation and evaluation pass; optional `approve` records a prior human review.
